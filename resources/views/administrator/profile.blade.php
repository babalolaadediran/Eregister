                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <form action="{{ url('administrator/update/profile') }}" method="POST" id="update-profile" novalidate>
                                    @csrf
                                    ...
                                    <div class="form-group {{ ($errors->has('email')) ? 'has-error' : '' }}">
                                        ...
                                        <input type="email" name="email" id="email" placeholder="Email" class="form-control" value="{{ $admin->email }}">
                                        @if ($errors->has('email'))
                                    ...
                                    <div class="form-group {{ ($errors->has('phone')) ? 'has-error' : '' }}">
                                        ...
                                        <input type="number" name="phone" id="phone" placeholder="XXXXXXXXXXX" class="form-control" min="0" value="{{ $admin->phone }}">
                                        @if ($errors->has('phone'))
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <form action="{{ url('administrator/update/password') }}" method="POST" id="update-password" novalidate>
                                    @csrf
